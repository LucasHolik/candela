...
void ShowBrightnessSlider(HWND parent)
{
    ...
    int x = pt.x - 65;  // 130/2
    int y = pt.y - 260; // Position it above the cursor, with more space for controls
